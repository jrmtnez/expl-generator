...
from pipeline.config import EVALUATED_NEWS_ITEMS_FILE_NAME, RESULTS_PATH, EVIDENCE_REASONING_FILE_NAME
...
def export_results(evaluated_model_label=O_GEMMA_LABEL,
    ...
    with open(join(RESULTS_ANALYSIS_PATH, EVIDENCE_REASONING_FILE_NAME % evaluated_model_label), "w", encoding="utf-8") as write_file:
...
if __name__ == '__main__':
    export_results(evaluated_model_label=O_GEMMA_LABEL, evaluator_model_1=O_GEMMA3_27B_LABEL, evaluator_model_2=O_DEEPSEEK_R1_32B_LABEL)
    export_results(evaluated_model_label=DEEPSEEK_R1_LABEL, evaluator_model_1=O_GEMMA3_27B_LABEL, evaluator_model_2=O_DEEPSEEK_R1_32B_LABEL)
